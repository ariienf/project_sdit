...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-dark topbar mb-4 static-top shadow">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-2 text-white">Laporan</h1>
...
<!-- Data Pengumuman -->
<div class="container">
<h2 class="text-center">Laporan Data</h2>
        ...
        <div class="card border-left-danger shadow h-100 py-2 bg-warning">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-md font-weight-bold text-white text-uppercase mb-1">LAPORAN DATA PENDAFTARAN</div>
                    </div>
                    <div class="col-auto">
                        <button type="button" class="btn btn-primary" onclick="window.location.href='data-pendaftaran-pdf.php'">Klik</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-danger shadow h-100 py-2 bg-warning">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-md font-weight-bold text-white text-uppercase mb-1">LAPORAN DATA PEMBAYARAN</div>
                    </div>
                    <div class="col-auto">
                        <button type="button" class="btn btn-primary" onclick="window.location.href='data-pembayaran-pdf.php'">Klik</button>
                    </div>
                </div>
            </div>
        </div>
