...
<section>
    ...
    <section>
            <div class="container bg-dark text-center text-white shadow-lg">
                <br>
                <img class="mb-4" src="logo.jpeg" alt="" width="200" height="200">
                <div class="col">
                    <h2>TERIMA KASIH PERSYARATAN ANDA KAMI AKAN SEGERA PROSES</h2>
                </div>
                <div class="col">
                    <h2>MOHON SEGERA MENGHUBUNGI PIHAK ADMIN SEKOLAH KAMI UNTUK INFORMASI LEBIH LANJUT</h2>
                    <h2> ↓↓↓↓↓ ↓↓↓↓↓ ↓↓↓↓↓ ↓↓↓↓↓</h2>
                </div>
                <hr>
                <div class="col">
                    <h3>ADMIN-1    : 0821 1150 3030 </h3>
                </div>
                <div class="col">
                    <h3>ADMIN-2    : 0857 2250 6060 </h3>
                </div>
                <br>
                <hr>
                <div class="col">
                    <a class="nav-link pb-0" href="pembayaran.php">
                        <h4>Klik untuk melanjutkan ke proses pembayaran</h4>
                    </a>
                </div>
                <hr>
                <br>
