...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-dark topbar mb-4 static-top shadow">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-2 text-white">Persyaratan</h1>
...
<!-- Form Persyaratan -->
<div class="container">
<h2 class="text-center">Formulir Persyaratan Peserta Didik Baru</h2>
<h2 class="text-center">SDIT Mutiara Islam</h2>
<hr class="mx-n3">
<form action="db_syarat.php" method="post">
        <div class="form-group">
            <label>Upload Foto KK (Kartu Keluarga) :</label>
            <input type="file" name="upload_kk" class="form-control" placeholder="Upload Foto KK" />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label>Upload Foto KTP Orang Tua (Ayah/Ibu) :</label>
            <input type="file" name="upload_ktp" class="form-control" placeholder="Upload Foto KTP Orang Tua" />
        </div>
        <br>
