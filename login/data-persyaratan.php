...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-dark topbar mb-4 static-top shadow">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-2 text-white">Data Persyaratan</h1>
...
<!-- Data Pendaftaran -->
<div class="container">
    <h2 class="text-center">Data Persyaratan Peserta Didik Baru</h2>
...
<div class="row">
    <div class="table-responsive table-bordered">
        <div class="page-header">
            <span class="fas fa-users text-primary mt-2 "> Data Persyaratan</span>
        </div>
        ...
        <tbody>
            ...
            $i = 1;
            $sql = "SELECT pendaftaran.NIK, pendaftaran.email, persyaratan.upload_kk,persyaratan.upload_akte,persyaratan.upload_ktp
                    FROM pendaftaran
                    JOIN persyaratan ON pendaftaran.id = persyaratan.id_peserta";
            ...
            ?>
                <tr>
                    ...
                    <td><?= $row['NIK']; ?></td>
                    <td><?= $row['email']; ?></td>
                    <td class="bg-success"><?= "<img src='$row[upload_kk]' width='70' height='90' />"; ?></td>
                    <td class="bg-success"><?= "<img src='$row[upload_akte]' width='70' height='90' />"; ?></td>
                    <td class="bg-success"><?= "<img src='$row[upload_ktp]' width='70' height='90' />"; ?></td>
                </tr>
            <?php } 
            } else {
                "Tidak ada data.";
