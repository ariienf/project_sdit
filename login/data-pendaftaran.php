...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-dark topbar mb-4 static-top shadow">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-2 text-white">Data Pendaftaran</h1>
...
<!-- Data Pendaftaran -->
<div class="container">
    <h2 class="text-center">Data Pendaftaran Peserta Didik Baru</h2>
...
<div class="row">
    <div class="table-responsive table-bordered">
        <div class="page-header">
            <span class="fas fa-users text-primary mt-2 "> Data Pendaftaran</span>
        </div>
        <table class="table mt-3">
            ...
            <tr>
                ...
                <th>Nama Panggilan Anak</th>
                <th>Jenis Kelamin</th>
                <th>Tempat Lahir</th>
                <th>Tanggal Lahir</th>
                <th>Golongan Darah</th>
                <th>Penyakit Derita</th>
